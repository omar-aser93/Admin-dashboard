...
const Product = ({ _id, name, description, price, rating, category, supply, stat }) => {
  ...
  const [isExpanded, setIsExpanded] = useState(false);        //state to store if product card collapsed or not
  
  return ( //render the product card & a collapse toggle button ... using MUI
